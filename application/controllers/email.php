    ...
    public function index($receiver)
    {
      // Konfigurasi email
        $config = [
               ...
               'smtp_user' => 'faris.php31@gmail.com',    // Ganti dengan email gmail kamu
               'smtp_pass' => '@FARISphp31@',      // Password gmail kamu
               'smtp_port' => 465,
               'crlf'      => "\r\n",
               'newline'   => "\r\n"
           ];
        ...
        $this->email->from('no-reply@tiket.com', 'Tiket.com');

        // Email penerima
        $this->email->to($receiver); // Ganti dengan email tujuan kamu
