			...
			<ul class="quick-menu pull-right">
				<li class="ribbon currency">
					...
					<ul class="menu mini">
						...
						if ($wkwk = $wkwk) {
							echo "<li><a href="; echo base_url('akun'); echo " title=\"My Profile\">Profile</a></li>";
							echo "<li><a href="; echo base_url('akun/logout'); echo "  title=\"Logout\">Logout</a></li>";
						} else {
							echo "<li><a href="; echo base_url('akun/login'); echo "  title=\"Login\">Login</a></li>";
							echo "<li><a href="; echo base_url('akun/register'); echo "  title=\"Register\">Register</a></li>";
						}
						?>
					</ul>
				</li>
